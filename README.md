...
## ⚙️ Y usamos el Modelo de regresión logística ya que permite estimar la probabilidad de que ocurra un evento (en este caso, ser usuario activo) en función de variables explicativas.
